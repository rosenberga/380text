//
//  TTFacebookScheduledQueryTableViewController.m
//  Text Timer
//
...
#import "TTFacebookScheduledQueryTableViewController.h"
#define CLASS @"Facebook"
#define CELL @"facebookSCell"
#define USERKEY1 @"email"
#define USERKEY2 @"email"
#define DATEKEY @"sendDate"
@interface TTFacebookScheduledQueryTableViewController ()

@end

@implementation TTFacebookScheduledQueryTableViewController
...
-(PFQuery *) queryForTable
{
    ...
    [query whereKey:DATEKEY greaterThan:[NSDate date]];
